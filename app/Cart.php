<?php
    ...
    class Cart{
        ...
        public function add($item,$product_id){
            $storedItem = ['qty'=>0,'product_id'=>0, 'product_name' => $item->nom_produit, 'product_price' => $item->prix, 'product_image' => $item->product_image, 'item' => $item];
        ...
        public function modiferQty($qty, $id){
